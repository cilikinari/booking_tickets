          ...
          child: Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                // 🟢 Validasi apakah pilihan ada di list, jika tidak kembalikan null
                value:
                    (bookingWatch.selectedCinema.isNotEmpty &&
                        cinemaList.contains(bookingWatch.selectedCinema))
                    ? bookingWatch.selectedCinema
                    : null,
                // 🟢 Teks bantuan saat belum ada pilihan yang valid
                hint: const Text(
                  "Pilih Bioskop",
                  style: TextStyle(color: Colors.white54),
                ),
                items: cinemaList.map((e) {
        ...
        _buildSectionCard(
          ...
          child: Column(
            ...
            children: [
              ...
              dateList.isEmpty
                  ? const Text(
                      "Pilih Studio/Bioskop terlebih dahulu",
